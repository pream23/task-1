'use client'
import { avatarPlaceholderUrl, navItems } from '@/contants'
    ...
    return (
        <aside className='sidebar'>
            ...
            <div className='sidebar-user-info'>
                <Image src={avatarPlaceholderUrl} alt='logo' width={44} height={44} className='sidebar-user-avatar' />
                <div className='hidden lg:block '>
                    <p className='subtitle-2 capitalize'>{firstName} {lastName}</p>
